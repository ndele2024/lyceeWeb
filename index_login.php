                ...
                <main>
                    <div class="mainpart p-4">
                        <form class="row g-3" name="formulaire" method="post" action="./control/firstcontrol.php">
                            <div class="col-12">
                                <label for="validationServerUsername" class="form-label">Entrer le code de votre établissement</label>
                                <div class="input-group has-validation">
                                    <span class="input-group-text" id="inputGroupPrepend3">
                                    	<img src="./ressources/user-3295.png" width="36" alt="logo username">
                                    </span>
                                    <input type="text" name="codeschool" class="form-control"
                                        id="validationServerUsername" placeholder="--code ici--" maxlength="25"
                            ...
                            <div class="mt-4">
                                <button class="btn btn-success w-100" name="validercodeschool" type="submit" id="bouton_index">Suivant</button>
                            </div>
                            <?php 
                                if(isset($_GET["errus"])) {
                                    if ($_GET["errus"]=="1") {
                                        echo "<div class='rouge'>Code incorect recommencer/ incorrect code. Please repeat</div>";
                                    }
                                    elseif ($_GET["errus"]=="2") {
